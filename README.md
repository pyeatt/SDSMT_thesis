...
If the automatic setup fails, you can generate everything manually.  Download and unpack the zip file, then open a terminal window and "cd" into the <code>SDSMT_thesis</code> directory.
