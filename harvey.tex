...
%% Thesiscitatinos provides extra \cite commands.
%% Read thesiscitations.pdf for the full list.
\usepackage{thesiscitations}
\bibliographystyle{thesis}

%% Comment the previous two lines and uncomment the next one
%% if you want to use a different bibliography/citation style.
